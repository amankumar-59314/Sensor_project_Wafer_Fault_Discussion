...
setup(
    ...
    author='Aman Kumar',  # Specify the author of the package
    author_email='amankumar59314@gmail.com',  # Specify the author's email
...
author='Aman Kumar': The name of the package author.
author_email='amankumar59314@gmail.com': The email address of the package author.
packages=find_packages(): Automatically find all packages and modules in the current directory.
